...
(
    roles_id BIGINT NOT NULL CONSTRAINT FK66OU45FYYDGLTRHVUC81RP15Q REFERENCES PUBLIC.roles,
    users_id BIGINT NOT NULL CONSTRAINT FKM3TMF7S11ILNY7LVPIKS60J0N REFERENCES PUBLIC.users,
...
(
    ...
    users_id BIGINT NOT NULL PRIMARY KEY CONSTRAINT FK6EMBKCEA1YF9FQC5UW27SH22I REFERENCES PUBLIC.users
);
...
(
    ...
    users_id   BIGINT NOT NULL PRIMARY KEY CONSTRAINT FK3M1QVQI0NDRB3OBPI1R1ICSMG REFERENCES PUBLIC.users
);